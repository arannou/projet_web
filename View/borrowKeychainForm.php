            ...
            <form action="?/borrowKeychain" method="post" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group" id="keyChainSelector">
                ...
                <select class="" name="keychainId">
                  <?php
                  foreach($controller->availableKeychains as $index => $keychain){
                    ?>
                ...
                <!-- Création de trousseaux par l'utilisateur -->
              ...
              <!-- Formulaire d'ajout de trousseaux à l'aide d'un CSV -->
              <div class="x_panel">
                <div class="x_title">
